        ...
        for rowi in range(len(self.listed_keyboard_layout)):
            ...
            for j in range(len(self.listed_keyboard_layout[rowi])):
                ...
                if shift_key != None and not shift_key.isalpha():
                    self.ax.text(x_pos + width / 5, y_start + 0.75, shift_key.upper(), ha='center', va='center', fontsize=10,font=KEY_FONT)
...
ergodox_keyboard_layout = [
    # Left hand
        ...
        [['ESC'], ['1', '!'], ['2', '@'], ['3', '#'], ['4', '$'],['5', '%'], ['%4%'], ['6', '^'] , ['7', '&'], ['8', '*'], ['9', '('], ['0', ')'], ['=', '+'], ['BACKSPACE']],
        [['TAB'], ['q', 'Q'], ['w', 'W'], ['e', 'E'], ['r', 'R'], ['t', 'T'], ['-'],['%4%'],['y', 'Y'], ['u', 'U'], ['i', 'I'], ['o', 'O'], ['p', 'P'], ['[', '{'], [']', '}']],
        [['CAPS'], ['a', 'A'], ['s', 'S'], ['d', 'D'], ['f', 'F'], ['g', 'G'],['%4%'],['h', 'H'], ['j', 'J'], ['k', 'K'], ['l', 'L'], [';', ':'], ['\'', '"'], ['ENTER']],
        [['SHIFT'], ['z', 'Z'], ['x', 'X'], ['c', 'C'], ['v', 'V'], ['b', 'B'],['%4%'],['n', 'N'], ['m', 'M'], [',', '<'], ['.', '>'], ['/', '?'], ['SHIFT']],
        [['CTRL'], ['WIN'], ['ALT'], ['SPACE'],['%4%'],['SPACE'], ['ALT'], ['WIN'], ['CTRL']],
        [['FN'], ['CTRL'],['%4%'],['ALT'], ['SPACE']]
]
